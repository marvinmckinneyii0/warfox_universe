      ...
      <section id="characters">
        <div className="container">
          ...
          <div style={{background:'var(--surface)',border:'1px solid var(--zerodiv-dim)',borderLeft:'3px solid var(--zerodiv-dim)',padding:'2rem 2.5rem',marginBottom:'2px'}}>
            ...
            <p style={{fontSize:'0.78rem',color:'var(--text-dim)',lineHeight:1.8,maxWidth:'90ch',marginBottom:'1rem'}}>Structured as an umbrella command architecture for ParkerGen's deniable operational units, it spans a spectrum from subtle to absolute. At the subtle end: infiltration, surveillance, long-game destabilization, corporate espionage, and the quiet management of information environments. At the absolute end: operations where ParkerGen's strategic continuity required outcomes that left no institutional record and no recoverable evidence. The gradient between those poles is graduated, compartmentalized, and color-designated internally in ways that ensure no single operator understands the full scope of what the architecture contains.</p>
            <p style={{fontSize:'0.78rem',color:'var(--text-dim)',lineHeight:1.8,maxWidth:'90ch',marginBottom:'1rem'}}>Zero Division is frightening not because it is violent. It is frightening because it is institutional. It reflects a corporation that anticipated resistance, internal betrayal, regulatory threat, and existential challenge at the founding level and built a permanent covert apparatus to address all of it before it arrived. ParkerGen did not develop Zero Division in response to threats. It built Zero Division because it always intended to operate in spaces where threats were inevitable.</p>
          </div>
          <div className="char-grid" style={{marginBottom:'4rem'}}>
            <div className="character-card">
          ...
          <div className="char-grid" style={{marginBottom:'4rem'}}>
            ...
            <div className="character-card">
              ...
              <div className="char-name">Dr. Kassandra Kane</div>
